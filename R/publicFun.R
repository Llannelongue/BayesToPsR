...
#' @export 
btops <- function(x, y, initialPrior, normalise = TRUE, features2norm = names(x), normaliseY = TRUE, decay = 0.1, blrResVariance = 1, modelSelection = "Bayes factors", 
    propagatePosterior = TRUE, weightsMethod = "mean", metric_createTree = "rmse", metric_finalWeights = "rmse", maxDepthTree = 10, maxSizeSlices = 500, 
    maxSplitValueTested = 50, minSizeLeaf = 1, minNbObsV2 = 1, printProgress = TRUE, seed = NA) {
    ...
    ToP <- btopsTrain(XtrainFull = x, YtrainFull = y, normalise = normalise, features2norm = features2norm, normaliseY = normaliseY, fracVal1 = , 
        fracVal2 = , maxDepthTree = maxDepthTree, blrResVariance = blrResVariance, bayesian = TRUE, initialPrior = initialPrior, modelSelection = modelSelection, 
        maxSizeSlices = maxSizeSlices, printProgress = printProgress, maxSplitValueTested = maxSplitValueTested, minSizeLeaf = minSizeLeaf, 
        propagatePosterior = propagatePosterior, decay = decay, weightsMethod = weightsMethod, minNbObsV2 = minNbObsV2, metric_createTree = metric_createTree, 
